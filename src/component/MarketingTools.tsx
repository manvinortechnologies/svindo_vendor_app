...
export type SecurityScreenNavigationProp = StackNavigationProp<RootStackParamList, 'OnlineStore'>;
...
const menuItems: MenuItemType[] = [
    { title: 'Online Store Settings', icon: 'store-settings', screen: 'OnlineStore' },
    ...
    { title: 'Customer Feedback', icon: 'star-circle', screen: 'CustomerFeedback' },
    ...
    { title: 'Manage Delivery', icon: 'truck-delivery-outline', screen: 'ManageDelivery' },
    { title: 'Transaction Messages', icon: 'message-text-outline', screen: 'TransactionMessages' },
  ]
...
const styles = StyleSheet.create({
    ...
    imageContainer:{alignContent:'center', justifyContent:'center', margin:10, },
