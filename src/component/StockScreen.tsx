...
import { View, Text, TextInput, TouchableOpacity, FlatList, ScrollView, StyleSheet, Platform, Image, Modal } from "react-native";
...
const products = [
    { id: "1", name: "White T Shirt", stock: 5, image: require("../assets/product.png"), price: 10 },
    { id: "2", name: "White T Shirt", stock: 5, image: require("../assets/product.png"), price: 10 },
    { id: "3", name: "White T Shirt", stock: 5, image: require("../assets/product.png"), price: 10 },
    { id: "4", name: "White T Shirt", stock: 5, image: require("../assets/product.png"), price: 10 },
  ];
...
const StockScreen = () => {
    ...
    return (
            ...
            <ScrollView style={styles.midcontent}>
                <View style={styles.searchBarContainer}>
                    <View style={styles.searchBar}>
                        ...
                        <TextInput placeholder="Search" placeholderTextColor="#006EB2" style={styles.searchInput} />
                        <TouchableOpacity>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={styles.productCard}>
                            ...
                            <Text style={styles.productDesc}>White cotton logo print</Text>
                            </View>
                                <View style={styles.quantityControl}>
                                    <TouchableOpacity onPress={() => updateQuantity(item.id, -1)} style={styles.quantityButton}>
                                    <Text style={[styles.quantityButtonText, { color: 'red' }]}>➖</Text>
                                    </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.addButtonGreen}>
          ...
          <Text style={styles.buttongreen}> <NavigationButton screen="CreateProduct" label="Add Product"  color="#00630F" fontSize={16} fontWeight="bold"/></Text>
        </TouchableOpacity>
        </View>
