...
import { View, Text, ScrollView, StyleSheet, TouchableOpacity, Platform, StatusBar, TextInput } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <TouchableOpacity style={styles.settingItem}  onPress={() => navigation.navigate('InvoiceTemplates')} >
        ...
        <View style={styles.settingItem}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.settingDesc}>Customise invoice color with your brand color</Text>
          </View>
          <CustomSwitch
        ...
        <TouchableOpacity style={styles.settingItem}>
          <View>
            ...
            <Text style={styles.settingDesc}>Active fields will be shown in the invoice</Text>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.settingItem}>
          <View>
            ...
            <Text style={styles.settingDesc}>Customise Invoice PDF Titles/Labels</Text>
          </View>
        </TouchableOpacity>
        ...
        <View style={styles.languageSection}>
          ...
          <Text style={styles.sectionDesc}>You can select language in the pdf and font style</Text>
          ...
          {[
           ...
           { key: 'showQuantityConversionRate', label: 'Show Quantity Conversion Rate' },
           { key: 'repeatHeader', label: 'Repeat Header' },
           { key: 'showReceiverSignature', label: "Show Receiver's Signature" },
        ...
        <View style={styles.invoicesection}>
          ...
          <Text style={styles.settingDesc}>loremipsumloremi...</Text>
          <Text style={[styles.inputLabel, { marginTop: 15 }]}>Tharmal Print Fotter</Text>
          <TextInput style={styles.input} placeholder="" />
          <Text style={styles.settingDesc}>loremipsumloremi...</Text>
        </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <TextInput style={styles.input} placeholder="" />
          <Text style={styles.settingDesc}>loremipsumloremi...</Text>
          <Text style={[styles.inputLabel, { marginTop: 15 }]}>Document Margin Bottom</Text>
          <TextInput style={styles.input} placeholder="" />
          <Text style={styles.settingDesc}>loremipsumloremi...</Text>
        </View>
       ...
       <View style={styles.section}>
          <Text style={styles.sectionHeader}>Invoice Header and Footer Images</Text>
          {['Invoice Header Image', 'Invoice Footer Image', 'Watermark Image'].map((item, idx) => (
