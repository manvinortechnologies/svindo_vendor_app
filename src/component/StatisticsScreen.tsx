...
import { View, Text, ScrollView, TouchableOpacity, StyleSheet, Dimensions, Platform, StatusBar, Image } from "react-native";
...
interface Product {
  ...
  const recentActivity = [
    { id: "1", userid: "@user65641", Comment: "liked your products", image: require("../assets/profile.png") },
    { id: "3", userid: "@user67890", Comment: "shared your product", image: require("../assets/profile.png") },
    { id: "4", userid: "@user67890", Comment: "shared your product", image: require("../assets/profile.png") }

  ];

  const notification = [
    { id: "1", date: "8 feb 2025", notify: "Lorem Ipsum is simply dummy text of the printing and typesetting", image: require("../assets/notification.png") },
    { id: "3", date: "8 feb 2025", notify: "Lorem Ipsum is simply dummy text of the printing and typesetting", image: require("../assets/notification.png") },
    { id: "4", date: "8 feb 2025", notify: "Lorem Ipsum is simply dummy text of the printing and typesetting", image: require("../assets/notification.png") }
  ...
  return (
    ...
    <View style={styles.titleRow}>
      ...
      <View style={styles.cardsContainer}>
        {[
          { title: "Total Purchases", value: "2,50,000", icon: "shopping-outline", change: "+0.50", changeColor: "green", changeIcon: "arrow-up" },
          { title: "Total Orders", value: "2,50,000", icon: "cart-outline", change: "-0.20", changeColor: "red", changeIcon: "arrow-down" },
          { title: "Total Expense", value: "2,50,000", icon: "file-document-edit-outline", change: "+0.50", changeColor: "green", changeIcon: "arrow-up" },
          { title: "Total Stock Value", value: "2,50,000", icon: "chart-line", change: "+0.50", changeColor: "green", changeIcon: "arrow-up" },
          { title: "Total Cash in Hand", value: "2,50,000", icon: "cash", change: "+0.50", changeColor: "green", changeIcon: "arrow-up" },
          { title: "Total Bank Balance", value: "2,50,000", icon: "bank", change: "+0.50", changeColor: "green", changeIcon: "arrow-up" },
        ].map((item, index) => (
          <View key={index} style={styles.card}>
            <View style={styles.cardContent}>
              <Icon name={item.icon} size={24} color="#333" style={styles.cardIcon} />
              <View style={styles.cardText}>
                <Text style={styles.cardTitle}>{item.title}</Text>
                <Text style={styles.cardValue}>Rs {item.value}</Text>
                <View style={styles.changeContainer}>
                  <Icon name={item.changeIcon} size={16} color={item.changeColor} />
                  <Text style={[styles.changeValue, { color: item.changeColor }]}>{item.change}</Text>
                </View>
              </View>
            </View>
            <View style={styles.cardFooter}>
              <Text style={styles.cardFooterText}>{item.title.split(" ")[1]}</Text>
  ...
  <View style={styles.recentActivityContainer}>
                ...
                {notification.map(notifications => (
                    <View key={notifications.id} style={styles.notificationcontain}>
                        <View style={styles.activityTextContainer}>
                           <Image source={notifications.image} style={styles.activityImage} />
                            <Text style={styles.notificationtext}>{notifications.notify}</Text>
                        </View>
...
const styles = StyleSheet.create({
  ...
  chartPlaceholder: { height: 220, justifyContent: "center",
  ...
  categoryTitle: { fontSize: 16, fontWeight: "bold", marginVertical: 10 ,color:"#FCA311"},
  ...
  insightLabel: { fontSize: 16, fontWeight: "bold", marginBottom: 5, color:"#FCA311" },
