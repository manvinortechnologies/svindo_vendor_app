...
const SelectLocationScreen: React.FC<SelectLocationScreenProps> = ({ navigation }) => {
  const [modalVisible, setModalVisible] = useState(false);

  return (
    <View style={styles.container}>
      <Image source={require('../assets/location_on.png')} style={styles.icon} />
      <Text style={styles.title}>Location</Text>
      <Text style={styles.subtitle}>
        Please enable location permission for better shopping experience
      </Text>
      
      <LinearGradient colors={['#F9C313', '#FCA511']} style={styles.continueButtonGradient}>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            <Text style={styles.modalTitle} >
              Allow <Text style={styles.svindotxt}>svindo</Text> to access this device's location?
            </Text>
            ...
            <View style={styles.locationOptions}>
              <View style={styles.locationOption}>
                <Image source={require('../assets/earth.png')} style={styles.mapIcon} />
                <Text>Precise</Text>
              </View>
              <View style={styles.locationOption}>
            ...
            <TouchableOpacity style={styles.modalButton} onPress={() => navigation.navigate('StatisticsScreen')}>
