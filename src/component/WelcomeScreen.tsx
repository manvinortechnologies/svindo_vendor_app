...
import { SignUpScreenProps, THomeNavigation, WelcomeScreenProps } from '../type';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.contentWrapper}>
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate(HomeNavigation.SIGNUP_SCREEN, { authType: "login" })}
                >
                    <LinearGradient
                ...
                <TouchableOpacity
                    style={styles.continueButtonWrapper}
                    onPress={() => navigation.navigate(HomeNavigation.SIGNUP_SCREEN, { authType: "signup" })}
                >
                    <LinearGradient
                        colors={['#F9C313', '#FCA511']}
                        style={styles.continueButtonGradient}>
