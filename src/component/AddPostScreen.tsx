...
import {
    ...
    StyleSheet, Switch, Image, ScrollView,
...
const AddPostScreen = () => {
    ...
    const handelSubmit = async () => {
        try {
            ...
            const apiEndPoing=media?.type?.startsWith('video')?"vendor/reel/":"vendor/post/";
          ...
          'Content-Type': 'multipart/form-data',
            ...
            console.log("res--->",res);
            if(res.status==201){
                Alert.alert("Success","Upload successful! Your content is now ready for review.")
            }
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                ...
                >
                    <ScrollView
                        ...
                        {/* Upload Box */}
                        <TouchableOpacity style={styles.uploadBox} onPress={handleMediaUpload}>
                            {media ? (
        ...
        /> */}
                        ...
                        <View style={styles.infoBox}>
                            <Text style={styles.infoText}>
                                <Text style={{ fontWeight: 'bold', color: "#FCA311" }}>Approximate Costing{'\n \n'}</Text>
                                per view cost: <Text style={{ fontWeight: 'bold' }}>10 paisa</Text> {'        '}
                                per view cost: <Text style={{ fontWeight: 'bold' }}>10 paisa</Text>
                            </Text>
                            <Text style={styles.cautionText}>Caution</Text>
                            <Text style={styles.termsText}>
                                Please follow platforms <Text style={styles.termsHighlight}>terms & conditions</Text> for speedy approval of campaigns
                            </Text>
                        </View>
                        <Loading
                        visible={isLoading}
