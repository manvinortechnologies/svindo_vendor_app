      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          <View style={styles.rowBetween}>
            <View>
              <Text style={styles.subtext}>Pro Forma Invoice #</Text>
              <Text style={styles.value}>SRTN-1</Text>
        ...
        {/* Vendor Selection */}
        <View>
          <Text style={styles.label}>Customer <Icon name="information" size={14} /></Text>
          <TouchableOpacity style={styles.selector}>
            <Text style={styles.selectorText}>+ Select Customer</Text>
          </TouchableOpacity>

          <Text style={styles.label}>Products <Icon name="information" size={14} /></Text>
          <TouchableOpacity style={styles.selector}>
...
export default CreateproFarmaInvoice