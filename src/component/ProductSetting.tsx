...
const productSettings = [
  'Wholesale price', 'Stock', 'IMEI / Serial Number', 'Low Stock Alert',
  'Category', 'Sub category', 'Brand Name', 'Color', 'Size',
  'Batch Number', 'Expiry Date', 'Description', 'Image', 'Tax', 'Food',
];

const deliveryDetails = ['Instant Delivery', 'Self Pickup', 'General Delivery'];

const policies = [
  'Return', 'COD', 'Replacement', 'Shop Exchange',
  'Shop Warranty', 'Brand Warranty', 'On shop orders',
];
        ...
        <ScrollView>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.note}>
              Note: Enabling this option will only post a catalog product to your svindo web page, where only images and product description is shown to the users.
            </Text>
          </View>

          <View style={styles.section}>
            <CustomButton title="Update Setting" onPress={updateProductSettings} />
          </View>
          <Loading 
          visible={isLoading}
          />
