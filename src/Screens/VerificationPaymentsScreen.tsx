          ...
          {["GSTIN", "UID", "PAN"].map((item, index) => (
            <View key={index} style={styles.verificationBlock}>
              ...
              <Text style={[styles.note, { marginVertical: 5 }]}>
                Note: To verify {item} details, a one time OTP will be sent to
                mobile number and email address of the primary {item} holder.
    ...
    },
    {
      ...
      content: (
        <View style={styles.sectionContent}>
          ...
          />
          <Text style={[styles.note, { marginVertical: 5 }]}>
            Note: To verify Fssai details, a one time OTP will be sent to mobile
            number and email address of the primary Fssai holder. OTP is valid
            for limited time.
          </Text>
          <TouchableOpacity style={styles.otpButton}>
            <Text style={styles.otpButtonText}>Generate OTP</Text>
    ...
    },
    {
      ...
      content: (
        <View style={styles.sectionContent}>
          ...
          <Text style={[styles.note, { marginVertical: 5 }]}>
            Note: To verify Account details, a one time OTP will be sent to
            mobile number and email address of the primary Account holder. OTP
            is valid for limited time.
          </Text>
          <TouchableOpacity style={styles.otpButton}>
