...
import { View, ScrollView, StyleSheet, StatusBar, Platform, TouchableOpacity, FlatList, Text } from 'react-native';
      ...
      /> 
            <ScrollView contentContainerStyle={styles.contentContainer}>
              <View style={styles.balanceBox}>
               ...
               {/* Transaction Details */}
            <View style={{borderWidth:1, borderColor: '#C7C7C7', padding: 5, paddingVertical: 10, borderRadius: 10}}>
              {/* Transaction Details Header */}
              <View style={styles.transactionHeader}><Text style={styles.transactionTitle}>Transaction Details</Text>
