      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.box}>
          <View style={styles.rowBetween}>
            <View>
              ...
              <Text style={styles.description}>
                This option helps you to boost your store visibility on svindo
                app. On enabling it your store logo and name will be recommended
                in main page and category level. It will be charged as per{" "}
          ...
          <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
            <Text style={{ color: "#FCA311", marginRight: 10 }}>
              Boosted on svindo
            </Text>
            <CustomSwitch
              value={boosted}
        ...
        <Text style={styles.boldText}>
          Boost Spotlight Product / Highlights
        </Text>
        <View style={styles.box}>
          <Text style={styles.description}>
            This option helps you to boost your product or reel/offer post
            visibility on svindo app. It will be charged as per{" "}
            <Text style={{ color: "#FF0000", fontWeight: "500" }}>
              terms & conditions
            </Text>
          </Text>
          ...
          renderItem={({ item }) => (
            <View
              style={[
                ...
                {
                  backgroundColor:
                    item.status === "Active" ? "#D8FFDE" : "#FFEAEA",
                },
              ]}
            >
              {/* Status Badge */}
                ...
                <Text
                  style={[
                    styles.statusText,
                    {
                      ...
                      borderColor:
                        item.status === "Active" ? "#00B74A" : "#FF0000",
                    },
                  ]}
                >
                  {item.status}
              ...
              <View style={styles.cardContent}>
                <Image
                  source={{
                    uri: "https://via.placeholder.com/60x30.png?text=PREET",
                  }}
