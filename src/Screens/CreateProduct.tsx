...
const CreateProduct = () => {
  return (
              ...
              <Icon  name="tooltip-image" color={"#000"} size={24}/>
                ...
                <ScrollView>
                    <View style={styles.addsection}>
                       ...
                       <Text style={styles.sublabel}>if the product you want to add to catelog is not available , Please create a new product. </Text>
                    </View>
                </ScrollView>
        ...
        <TouchableOpacity style={styles.addButtonGreen}>
          ...
          <Text style={styles.buttongreen}> <NavigationButton screen="AddProductScreen" label="Create New"  color="#00630F" fontSize={16} fontWeight="bold"/></Text>
        </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
    container: { padding: 10, backgroundColor: "#FFF",
       ...
       floatingButtons: { position: "absolute", top: "90%", right: 20,
