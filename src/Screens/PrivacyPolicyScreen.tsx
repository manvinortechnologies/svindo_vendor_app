    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.paragraph}>
          <Text style={styles.bold}>We</Text> value your privacy and are
        ...
        <Text style={styles.paragraph}>
          <Text style={styles.bold}>Your information helps us:</Text>
        </Text>
        <Text style={styles.bullet}>
        ...
        <Text style={styles.paragraph}>
          <Text style={styles.bold}>We</Text> implement security measures to
        ...
        <Text style={styles.paragraph}>
          ...
          information. Contact us for any privacy-related concerns.
        </Text>
