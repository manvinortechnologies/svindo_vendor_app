...
const summaryData = [
  ...
  { label: 'Purchase', value: '123455', color: '#E0F2FE', borderColor: '#163881' },
  { label: 'Stock', value: '123455', color: '#E0F2FE', borderColor: '#163881' },
  { label: 'Receipts', value: '123455', color: '#FEF3C7', borderColor: '#FCA311' },
  { label: 'Payments', value: '123455', color: '#FEE2E2', borderColor: '#FF0000' },
  { label: 'Expenses', value: '123455', color: '#FEE2E2', borderColor: '#FF0000' },
];
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={styles.dateContainer}>
          <TouchableOpacity style={styles.dateButton} onPress={() => showDatePicker(true)}>
            ...
            <Icon name="calendar" size={18} color="#F59E0B" style={{ marginLeft: 4 }} />
          </TouchableOpacity>
        </View>

        {/* All Content */}
        <FlatList data={transactions} keyExtractor={(item, index) => index.toString()}
        ListHeaderComponent={
          <>
          {/* Summary Cards */}
          <View style={styles.summaryContainer}>
            {summaryData.map((item) => (
              <View key={item.label} style={[styles.summaryCard, {backgroundColor: item.color, borderWidth: 1, borderColor: item.borderColor}]}>
                <Text style={[styles.summaryLabel, {color: item.borderColor}]}>{item.label}</Text>
