...
import { View, ScrollView, StyleSheet, StatusBar, Platform, Text, Image } from 'react-native';
...
<View style={styles.reviewHeader}>
  ...
  <View style={styles.reviewCirclesRow}>
    <View style={styles.circleContainer}>
      ...
      <View style={[styles.circle, styles.activeCircle, { left: 36 }]} />
    </View>
    <Icon name="dots-horizontal" size={20} color="#fff" style={{ marginLeft: 8 }} />
  </View>
</View>
        ...
        {reviews.map((item, index) => (
          <View key={item.id} style={styles.card}>
            ...
            <Text style={styles.reviewText}>
              {item.review.substring(0, 90)}...<Text style={styles.readMore}>read more</Text>
            </Text>
